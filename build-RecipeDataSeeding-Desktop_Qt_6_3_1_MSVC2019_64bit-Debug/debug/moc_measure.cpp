...
#include <memory>
#include "../../RecipeDataSeeding/measure.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_measure_t, stringdata0) + ofs), len 
...
const QMetaObject measure::staticMetaObject = { {
    ...
    qt_meta_stringdata_measure.offsetsAndSize,
    qt_meta_data_measure,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_measure_t
...
void *measure::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_measure.stringdata0))
